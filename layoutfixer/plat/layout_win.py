"""
plat/layout_win.py — Switch the foreground window's keyboard layout via WinAPI.

Moved verbatim from layout_switcher.py. Only imported on sys.platform == 'win32'.
"""
import ctypes
import logging
